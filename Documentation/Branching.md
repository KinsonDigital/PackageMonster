...
**GotNuget** uses a more complicated branching model, but it gives you more control of the SDLC (Software Development Life Cycle).  This branching model allows a clear purpose for adding features, bug fixes, preview releases, QA releases and standard releases.
...
Long living branch that represents stable production versions of **GotNuget**:
